        ...
        <div class="content-body">
            <div class="row">
                <?php
                    ...
                    {
                        $_SESSION['dept_id']=$_POST["details"];
                    }
                ...
                ?>
                <div class="container">
                    <div class="row justify-content-center dethead">
                        Department of <?=$row["dept_name"]?>
                    </div>
                
                    <div class="row">
                        <div class="col det">
                            <?=$row["dept_detail"]?><br><br>
                            <?=$row["dept_more_detail"]?>
                        </div>
                        <div class="col align-center mt-5">
                            <img src="../images/<?php echo $row['image1']; ?>" width=250 height=400>
                        </div>
                    </div>
                </div>
                <?php }}?>    
            ...
            <div class="row ml-3">
                <?php
                $dept_id=$_SESSION['dept_id'];
                $sql="SELECT * from tbl_doctor where dept_id='$dept_id'";
                $result=$con->query($sql);
				if ($result-> num_rows > 0){
					while ($row=$result-> fetch_assoc()) {
                ?>
