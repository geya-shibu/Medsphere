                ...
                <div class="col-5">
                    ...
                    <form method="post" action="process_report.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="blood_pressure" id="blood_pressure" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cholestrol" id="cholestrol" required>
                        </div>
                        <div class="form-group">
